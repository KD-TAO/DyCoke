                ...
                for image_idx, image_feature in enumerate(image_features):
                    ...
                    if image_idx in video_idx_in_batch:  # video operations
                        ...
                        if mm_newline_position == "grid":
                            ...
                            if 'unpad' in mm_patch_merge_type:
                                if self.dycoke:
                                    image_feature = dycole_ttm(image_feature, self.dycoke_num_tokens_per_frame, self.dycoke_k)
                                    self.model.DycokeConfig.image_token_length = image_feature.size()[0] - 1
                                    #print(self.model.DycokeConfig.image_token_length)
