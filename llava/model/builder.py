...
def load_pretrained_model(model_path, model_base, model_name, load_8bit=False, load_4bit=False, device_map="auto", torch_dtype="float16",attn_implementation="flash_attention_2", customized_config=None, overwrite_config=None, dycoke=False, dycoke_l=3, dycoke_p=0.8, dycoke_num_tokens_per_frame=196, dycoke_k=0.3, image_token_start_index = 14, **kwargs):
    ...
    # DyCoke Parameters
    model.dycoke = dycoke
    model.dycoke_l = dycoke_l
    model.dycoke_p = dycoke_p
    model.dycoke_num_tokens_per_frame = dycoke_num_tokens_per_frame
    model.dycoke_k = dycoke_k
    model.image_token_start_index = image_token_start_index
